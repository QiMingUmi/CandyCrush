...
var Rules = function(board)
{
  ...
  *
  */
  // 这段代码用于初始化一个新游戏，主要包括以下几个步骤：
  // 1. 使用populateBoard()函数填充棋盘
  // 2. 使用getCandyCrushes()函数获取可以消除的candies
  // 3. 使用removeCrushes()函数消除这些candies
  // 4. 重复步骤2和3，直到没有可以消除的candies为止
  ...
  */
  this.moveCandiesDown = function()
  {
    ...
    // Collapse each column 从左往右，从底向上
    for (var col = 0; col < board.boardSize; col++)
    {
      ...
      // Then shift any nonempty rows up 向下滑动
